...
select sum(price) from  item where category='Electronics';


SELECT 
    SUM(o.quantity * i.price) AS total_earnings
FROM item i
JOIN orders o 
    ON i.id = o.item_id
WHERE i.category = 'Electronics';
 
 -- on which of the following dates highest no of units are sold  options 2022-08-25,2020-03-20,2023-07-15,2020-11-09
 SELECT 
    category,
